...
function usage(): string { return ['Usage:', '  jira-markdown-export --issue-keys ATT-1,ATT-2 --output-dir /path/to/Tasks [--download-attachments] [--json]', '  jira-markdown-export --jql "project = ATT" --output-dir /path/to/Tasks [--download-attachments] [--json]'].join('\n'); }
